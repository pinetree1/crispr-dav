...
my $usage = "Usage: $0 targetseq_file(e.g. sample1.GENEX_CR1.tgt) 
    ...
    paired-end reads match in the overlapping region. 

    For WT reads, the sgRNA region is compared. For Indel reads,
    the combination of position and indel length is compared.
";
